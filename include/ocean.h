...
void pacifica_add_whitecaps()
{
  ...
  for (uint16_t i = 0; i < LEDS_PER_STRIP; i++)
  {
    ...
    if (l > threshold)
    {
      ...
      leds4[i] += CRGB(overage, overage2, qadd8(overage2, overage2));
    }
  }
}
...
void pacifica_deepen_colors()
{
  for (uint16_t i = 0; i < LEDS_PER_STRIP; i++)
  {
    ...
    // leds[i] |= CRGB( 2, 5, 7);
    leds1[i].blue = scale8(leds1[i].blue, 145);
    leds1[i].green = scale8(leds1[i].green, 200);
    leds1[i] |= CRGB(2, 5, 7);
    
    leds2[i].blue = scale8(leds2[i].blue, 145);
    leds2[i].green = scale8(leds2[i].green, 200);
    leds2[i] |= CRGB(2, 5, 7);
    
    leds3[i].blue = scale8(leds3[i].blue, 145);
    leds3[i].green = scale8(leds3[i].green, 200);
    leds3[i] |= CRGB(2, 5, 7);
    
    leds4[i].blue = scale8(leds4[i].blue, 145);
    leds4[i].green = scale8(leds4[i].green, 200);
    leds4[i] |= CRGB(2, 5, 7);
  }
}
